...
mod testing {
    ...
    fn oracle_test_query_get_config_and_current_prices<T: Into<String>>(
        ...
        let msg: oracle::msg::QueryMsg = oracle::msg::QueryMsg::GetConfigAndCurrentPrices {};
    ...
    fn oracle_test_query_get_usdc_price_from_amount_and_denom<T: Into<String>>(
        ...
        let msg: oracle::msg::QueryMsg =
            oracle::msg::QueryMsg::GetUsdcPriceFromAmountAndDenom { amount, denom };
    ...
    fn oracle_test_query_get_latest_historical_prices<T: Into<String>>(
        ...
        let msg: oracle::msg::QueryMsg =
            oracle::msg::QueryMsg::GetLatestHistoricalPrices { length };
