...
pub const RECEIVER_FEES: &str = "chihuahua1receiver";
pub const INITER: &str = "chihuahua1ifxixonpu9laitc4w6f17m2jfin3hchp4n8511";
pub const RECIPIENT_REVENUES: &str = "chihuahua1ifxixonpu9laitc4w6f17m2jfin3hchp4n85ee";
